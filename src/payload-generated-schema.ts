...
export const blogs_populated_authors = sqliteTable(
...
export const blogs_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    blogs_rels_blogs_id_idx: index('blogs_rels_blogs_id_idx').on(columns.blogsID),
    blogs_rels_categories_id_idx: index('blogs_rels_categories_id_idx').on(columns.categoriesID),
    blogs_rels_users_id_idx: index('blogs_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [blogs.id],
    ...
    usersIdFk: foreignKey({
      columns: [columns['usersID']],
      foreignColumns: [users.id],
      name: 'blogs_rels_users_fk',
    }).onDelete('cascade'),
  }),
)

export const _blogs_v_version_populated_authors = sqliteTable(
...
export const _blogs_v_rels = sqliteTable(
  ...
  (columns) => ({
    order: index('_blogs_v_rels_order_idx').on(columns.order),
    parentIdx: index('_blogs_v_rels_parent_idx').on(columns.parent),
    pathIdx: index('_blogs_v_rels_path_idx').on(columns.path),
    _blogs_v_rels_blogs_id_idx: index('_blogs_v_rels_blogs_id_idx').on(columns.blogsID),
    _blogs_v_rels_categories_id_idx: index('_blogs_v_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    _blogs_v_rels_users_id_idx: index('_blogs_v_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_blogs_v.id],
      name: '_blogs_v_rels_parent_fk',
    }).onDelete('cascade'),
    blogsIdFk: foreignKey({
      columns: [columns['blogsID']],
      foreignColumns: [blogs.id],
      name: '_blogs_v_rels_blogs_fk',
    }).onDelete('cascade'),
    categoriesIdFk: foreignKey({
      columns: [columns['categoriesID']],
      foreignColumns: [categories.id],
...
export const projects_populated_authors = sqliteTable(
  ...
  (columns) => ({
    _orderIdx: index('projects_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('projects_populated_authors_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const projects_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    projects_rels_categories_id_idx: index('projects_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    projects_rels_users_id_idx: index('projects_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [projects.id],
...
export const _projects_v_version_populated_authors = sqliteTable(
  ...
  (columns) => ({
    _orderIdx: index('_projects_v_version_populated_authors_order_idx').on(columns._order),
    _parentIDIdx: index('_projects_v_version_populated_authors_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const _projects_v_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    _projects_v_rels_categories_id_idx: index('_projects_v_rels_categories_id_idx').on(
      columns.categoriesID,
    ),
    _projects_v_rels_users_id_idx: index('_projects_v_rels_users_id_idx').on(columns.usersID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_projects_v.id],
...
export const media = sqliteTable(
  'media',
  {
    ...
    prefix: text('prefix').default('hyperfuse/'),
    updatedAt: text('updated_at')
      .notNull()
      .default(sql`(strftime('%Y-%m-%dT%H:%M:%fZ', 'now'))`),
    createdAt: text('created_at')
...
export const homepage_offer_offerings = sqliteTable(
  'homepage_offer_offerings',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: text('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('homepage_offer_offerings_order_idx').on(columns._order),
    _parentIDIdx: index('homepage_offer_offerings_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [homepage.id],
      name: 'homepage_offer_offerings_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const homepage = sqliteTable(
  'homepage',
  {
    ...
    intro_content: text('intro_content', { mode: 'json' }),
    intro_ctaText: text('intro_cta_text'),
    intro_ctaLink: text('intro_cta_link'),
    projects_image: integer('projects_image_id')
      .notNull()
      .references(() => media.id, {
        onDelete: 'set null',
      }),
    projects_title: text('projects_title'),
    projects_description: text('projects_description', { mode: 'json' }),
    featuredProjects_ctaText: text('featured_projects_cta_text'),
    featuredProjects_ctaLink: text('featured_projects_cta_link'),
    outro_title: text('outro_title'),
    insights_title: text('insights_title'),
    insights_description: text('insights_description', { mode: 'json' }),
    insights_ctaText: text('insights_cta_text'),
    insights_ctaLink: text('insights_cta_link'),
    updatedAt: text('updated_at').default(sql`(strftime('%Y-%m-%dT%H:%M:%fZ', 'now'))`),
    createdAt: text('created_at').default(sql`(strftime('%Y-%m-%dT%H:%M:%fZ', 'now'))`),
  },
  (columns) => ({
    homepage_hero_hero_hero_image_idx: index('homepage_hero_hero_hero_image_idx').on(
      columns.hero_heroImage,
    ),
    homepage_projects_projects_image_idx: index('homepage_projects_projects_image_idx').on(
      columns.projects_image,
    ),
  }),
)
...
export const homepage_rels = sqliteTable(
  ...
  (columns) => ({
    ...
    homepage_rels_projects_id_idx: index('homepage_rels_projects_id_idx').on(columns.projectsID),
    homepage_rels_posts_id_idx: index('homepage_rels_posts_id_idx').on(columns.postsID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [homepage.id],
...
export const relations_homepage_offer_offerings = relations(
  homepage_offer_offerings,
  ({ one }) => ({
    _parentID: one(homepage, {
      fields: [homepage_offer_offerings._parentID],
      references: [homepage.id],
      relationName: 'offer_offerings',
    }),
  }),
)
...
export const relations_homepage = relations(homepage, ({ one, many }) => ({
  hero_heroImage: one(media, {
    fields: [homepage.hero_heroImage],
    references: [media.id],
    relationName: 'hero_heroImage',
  }),
  offer_offerings: many(homepage_offer_offerings, {
    relationName: 'offer_offerings',
  }),
  projects_image: one(media, {
    fields: [homepage.projects_image],
    references: [media.id],
    relationName: 'projects_image',
  }),
...
type DatabaseSchema = {
  ...
  homepage_offer_offerings: typeof homepage_offer_offerings
  ...
  relations_homepage_offer_offerings: typeof relations_homepage_offer_offerings
