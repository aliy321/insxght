...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'route-seo': RouteSeoSelect<false> | RouteSeoSelect<true>;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'route-seo';
        value: number | RouteSeo;
      } | null)
    | ({
        relationTo: 'media';
        value: number | Media;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "route-seo_select".
 */
export interface RouteSeoSelect<T extends boolean = true> {
  path?: T;
  title?: T;
  description?: T;
  image?: T;
